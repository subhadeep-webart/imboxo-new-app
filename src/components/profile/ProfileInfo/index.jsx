    ...
    return (
        <div className={styles.profile_info_wrapper}>
            <div className={styles.profile_image}>
                <Image src={profile_img ? profile_img : "/assets/images/user-avatar.jpg"} fill className="object-cover" />
            </div>
                ...
                <div className={styles.profile_navigation}>
                    {
                        profileNavMenu.map((profileNav, index) => (
                            <ProfileNavigation key={`profile_menu_${index + 1}`} profileNav={profileNav} />
                        ))
                    }
                </div>
            </div>
