                ...
                <div className="section-content">
                    ...
                    >
                        ...
                        <SwiperSlide
                            ...
                            onMouseLeave={handleMouseLeave}
                        >
                            <div className={`${hoveredIndex === 1 ? "visionary-thumb-bigger relative" : "visionary-thumb"}`}>
                                <Image src="/assets/images/visionary-2.png" alt="" fill />
                            </div>
                            {hoveredIndex === 1 ? (
                                <>
                                    {/* <div className="w-20 h-5 rounded-full bg-[#806BBB] flex justify-center items-center absolute end-0 top-0 text-white text-sm">
                        <p>Most Liked</p>
                    </div> */}
                                    <div className="visionary-info">
                                        <h4 className="visionary-name">Jordon Sharma</h4>
